	...
	*/
	...
	var Test=(function(){
		...
		__proto.loadImgComplete=function(){
			...
			spt.x=200;
			spt.y=0;
			var maskImg=new Image("yellow.png");
			spt.width=129;
			spt.height=352;
			this.content=new Sprite();
			this.content.width=129;
			spt.addChild(this.content);
			for (var i=0;i < 5;i++){
				var img=new Image("bg.png");
				img.y=i *130;
				this.content.addChild(img);
			}
			this.content.height=i *130;
			spt.mask=maskImg;
			spt.on("mousedown",this,this.contentMouseDown);
			Laya.stage.on("mouseup",this,this.contentMouseUp);
